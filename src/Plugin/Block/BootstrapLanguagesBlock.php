...
namespace Drupal\rrho_bootstrap_languages\Plugin\Block;
 ...
 *
 * @Block(
 *  id = "rrho_bootstrap_languages",
 *  admin_label = @Translation("Bootstrap Language switcher"),
 *  deriver = "Drupal\rrho_bootstrap_languages\Plugin\Derivative\BootstrapLanguagesBlock"
 * )
 */
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['bootstrap_language']['dropdown_style'] = [
      ...
      '#options' => [
        ...
        'text' => $this->t('Only text'),  // diao added
      ],
  ...
  public function build() {
    ...
    if (isset($links->links)) {
      $build = [
        ...
        '#attached' => [
          'library' => [
            'rrho_bootstrap_languages/default',
          ],
        ],
      ];
    }
